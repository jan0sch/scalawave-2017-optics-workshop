...
class PrismSpec extends Specification {
  ...
  def test01 = {
    ...
    Json._jsString.getOption(probablyJsonString)
    ko("implement me")
  }
  ...
  def test02 = {
    ...
    Json._jsString.getOption(defiantlyNotJsonString)
    ko("implement me")
  }
  ...
  def test03 = {
    ...
    Json._jsNumber.getOption(maybeJsonNumber)
    ko("implement me")
  }
  ...
  def test04 = {
    ...
    Json._jsNumber.getOption(defiantlyNotJsonNumber)
    ko("implement me")
  }
  ...
  def test05 = {
    ...
    val _prirsmToJSNumber: Prism[Json, JsNumber] = ???

    val composed: Prism[Json, Int] = ???
